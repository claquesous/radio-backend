...
namespace :deploy do
  desc "Clean up old releases, keeping only the five most recent ones and the current symlinked directory"
  ...
  desc "Create a new release directory with the current timestamp and update the current symlink"
  task :create_new_release do
